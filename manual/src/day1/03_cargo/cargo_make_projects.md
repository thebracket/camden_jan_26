...
Let's all fire up a terminal. Create and navigate to a scratch directory (I'm using `l3h`). Then we'll use `cargo new` to create a new project.
...
Now open the `hello_l3h` directory in your editor of choice.
