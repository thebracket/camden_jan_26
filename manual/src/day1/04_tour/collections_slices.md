...
Slices are a view into a contiguous sequence of elements in a collection. They are much like `(element *), size` in C, or a view/span in C++. They work with any collection that is stored in a contiguous block of memory, such as arrays and vectors.
